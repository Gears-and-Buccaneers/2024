...
class IntakeUTest {
  ...
  void setup() {
    ...
    m_simMotor = new PWMSim(1); // create our simulation PWM motor controller
    m_simPiston =
        new DoubleSolenoidSim(PneumaticsModuleType.CTREPCM, 2, 3); // create our simulation solenoid
  }
