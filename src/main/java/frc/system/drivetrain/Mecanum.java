...
// */
// public Mecanum(IMU imu, Module frontLeft, Module frontRight, Module rearLeft,
// Module rearRight) {
// this.imu = imu;
...
// kinematics = new MecanumDriveKinematics(frontLeft.offset, frontRight.offset,
// rearLeft.offset, rearRight.offset);

// odometry = new MecanumDrivePoseEstimator(kinematics, imu.yaw(), positions(),
// new Pose2d());
// }

// /** Collects the positions of the modules */
// MecanumDriveWheelPositions positions() {
// return new MecanumDriveWheelPositions(frontLeft.position(),
// frontRight.position(),
...
// MecanumDriveWheelSpeeds states = kinematics.toWheelSpeeds(speeds);
...
// @Override
// public void drive(Pose2d position) {
